...
export default class Pause extends Phaser.Scene {
	...
	editorCreate(): void {
		...
		pauseText.tintTopLeft = 0;
		pauseText.tintTopRight = 0;
		pauseText.tintBottomLeft = 0;
		pauseText.tintBottomRight = 0;
		...
		contDesc.tintTopLeft = 0;
		contDesc.tintTopRight = 0;
		contDesc.tintBottomLeft = 0;
		contDesc.tintBottomRight = 0;
